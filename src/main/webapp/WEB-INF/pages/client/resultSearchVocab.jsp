	...
	<div class="span3">
		<div class="side-bar">
			...
			<ul class="nav nav-list">
				<li><a href="/webtoeic/listening">듣기 수업 연습</a></li>
				<li><a href="/webtoeic/reading">독서 연습</a></li>
				<li><a href="/webtoeic/listExam">오디션</a></li>
				<li><a href="/webtoeic/listGrammar">문법 공부</a></li>
				<li><a href="/webtoeic/listVocab">어휘를 배우세요</a></li>
			</ul>
		</div>
	</div>
</div>
